  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      >
        ...
        <p className="text-[#6B7B8D] dark:text-white/50 text-sm md:text-base">{subtitle}</p>
      </motion.div>
        ...
        {options.map((option) => {
          ...
          return (
            <motion.button
              ...
              className={`relative group flex flex-col items-center justify-center gap-3 p-6 rounded-2xl backdrop-blur-md border transition-all duration-300 cursor-pointer ${
                isSelected
            ...
            >
              ...
              {isSelected && (
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  className="absolute top-3 right-3 w-5 h-5 rounded-full bg-gradient-to-r from-[#5B8DD9] to-[#3E6BB5] flex items-center justify-center"
                >
                  <svg
